...
PLANS = [
    {
        ...
        "price": "R$ 0",
        "period": "/sempre",
        "tagline": "Para conhecer a plataforma sem compromisso",
        "features": [
            "2 backtests por mês (Cripto, Forex, Índices, Stocks)",
            "IA interpreta sua estratégia em texto livre — médias móveis, RSI e setups de Smart Money Concepts (varredura de liquidez, BOS, CHoCH)",
            "Dashboard completo de métricas: Win Rate, Profit Factor, Drawdown, Expectativa e mais",
    ...
    },
    {
        ...
        "price": "R$ 97",
        "period": "/mês",
        "tagline": "Para quem testa e ajusta estratégias com frequência",
        "features": [
            "500 backtests por mês (Cripto, Forex, Índices, Stocks)",
            "IA interpreta sua estratégia em texto livre — médias móveis, RSI e setups de Smart Money Concepts",
            "Dashboard completo de métricas + Equity Curve",
            "50 Pareceres Técnicos com IA por mês",
            "Modo Otimização: testa dezenas de variações da sua estratégia automaticamente e mostra a melhor combinação",
        ],
        "cta": "Assinar Pro",
        "badge": "MAIS POPULAR",
    },
    {
        ...
        "price": "R$ 297",
        "period": "/mês",
        "tagline": "Para quem opera com sinais em tempo real",
        "features": [
            "2.000 backtests por mês (Cripto, Forex, Índices, Stocks)",
            "IA interpreta sua estratégia em texto livre — médias móveis, RSI e setups de Smart Money Concepts",
            "Dashboard completo de métricas + Equity Curve",
            "500 Pareceres Técnicos com IA por mês, com modelo de IA mais avançado (análise mais aprofundada)",
            "Modo Otimização: testa dezenas de variações automaticamente",
            "Exportação de relatório completo em HTML e PDF",
            "Bot privado de alertas no Telegram — receba o sinal assim que ele aparecer",
        ],
        "cta": "Assinar VIP",
        "badge": None,
    },
